...
This is the special `VaibhavJ97/VaibhavJ97` repo that GitHub renders as the introduction on my profile page. It exists purely to display this README on [github.com/VaibhavJ97](https://github.com/VaibhavJ97). There's no code here.
...
- **Location**: Karlsruhe, Germany (open to relocation within Germany, open to remote)
